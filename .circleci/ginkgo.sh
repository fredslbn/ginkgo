...
ZIPNAME="SUPER.KERNEL-GINKGO-CLO-$(TZ=Asia/Jakarta date +"%Y%m%d-%H%M").zip"
...
function cloneTC() {
	...
	https://android.googlesource.com/platform/prebuilts/clang/host/linux-x86/+archive/914f9e5ae603f1a290c92160e3958c251184d3f0/clang-r458507.tar.gz
